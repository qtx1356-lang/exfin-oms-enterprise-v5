  ...
  return (
    <div className="min-h-screen bg-[var(--app-background)] text-[var(--text-primary)] p-4 flex flex-col items-center justify-center font-sans relative overflow-hidden">
      ...
      <div className="max-w-md w-full glass-card-elevated p-10 text-center flex flex-col items-center relative z-10">
        <div className="w-20 h-20 bg-[var(--success)]/10 border border-[var(--success)]/30 rounded-full flex items-center justify-center mb-8 shadow-2xl relative">
          <Clock className="w-10 h-10 text-[var(--success)]" />
          <div className="absolute inset-0 bg-[var(--success)]/10 blur-xl rounded-full -z-10 animate-pulse" />
        </div>
        ...
        <p className="text-[var(--text-secondary)] text-xs leading-relaxed font-medium max-w-[260px]">
          Your device authentication is pending administrative review. You will receive access to the <span className="text-[var(--success)] font-bold">Executive Portal</span> upon verification.
        </p>
