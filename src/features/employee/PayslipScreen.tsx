    ...
    <div className="flex flex-col gap-5 pb-8 text-[var(--text-primary)]">
        ...
        {payslips.length > 1 && (
          <div className="relative">
            <button
              ...
              className="flex items-center gap-1.5 bg-[var(--app-bg-secondary)] border border-[var(--primary)]/30 px-3.5 py-1.5 rounded-full text-xs font-bold text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--primary)]/20 transition cursor-pointer"
            >
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-1.5 w-44 bg-[var(--card-bg)] border border-[var(--primary)]/30 rounded-xl shadow-2xl z-50 overflow-hidden divide-y divide-[var(--primary)]/10">
                {payslips.map((slip) => (
                  <button
                    key={slip.id}
                    onClick={() => {
                    ...
                    className={`w-full text-left p-2.5 text-xs font-bold hover:bg-[var(--primary)]/10 transition flex items-center justify-between ${
                      selectedPayslip?.id === slip.id ? 'bg-[var(--app-bg-primary)] text-[var(--text-primary)]' : 'text-[var(--text-secondary)]'
                    }`}
                  >
      ...
      {selectedPayslip && (
        <div className="flex flex-col gap-4">
          ...
          {/* Main Payslip Card */}
          <Card className="p-6 bg-[var(--card-bg)] border border-[var(--primary)]/25 rounded-[24px] shadow-2xl space-y-6 relative overflow-hidden">
            ...
            {/* Payslip Header */}
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center pb-4 border-b border-[var(--primary)]/15 gap-4">
              <div>
                <span className="text-[9px] font-black uppercase text-[var(--primary)] tracking-wider">OFFICIAL SALARY SLIP</span>
                <h2 className="text-xl font-black text-[var(--text-primary)] tracking-tight mt-0.5">Office Management System</h2>
                <p className="text-[10px] text-[var(--text-secondary)]/70 font-bold font-mono">Enterprise Operations & Workforce Portal</p>
              </div>
              <div className="text-right sm:text-right flex flex-col sm:items-end">
                <span className="px-3 py-1 rounded-full text-[10px] font-black bg-[var(--primary)]/25 border border-[var(--primary)]/30 text-[var(--primary-light)] uppercase tracking-wide">
                  {currentMonthName} {currentYear}
                </span>
                <span className="text-[9px] text-[var(--text-secondary)]/60 font-bold mt-1.5 block">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-[var(--app-bg-primary)]/60 p-4 rounded-2xl border border-[var(--primary)]/10">
              <div className="space-y-2.5">
                <div className="flex items-center gap-2">
                  <User className="w-4 h-4 text-[var(--primary)] shrink-0" />
                  <span className="text-xs text-[var(--text-secondary)]/80 font-bold">Employee Name:</span>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-[var(--text-secondary)]/80 font-bold">Employee Code:</span>
                  <strong className="text-xs font-mono font-black text-[var(--text-primary)] ml-auto md:ml-2">{selectedPayslip.employeeCode}</strong>
                </div>
                <div className="flex items-center gap-2">
                  <Building className="w-4 h-4 text-[var(--primary)] shrink-0" />
                  <span className="text-xs text-[var(--text-secondary)]/80 font-bold">Department:</span>
                  <strong className="text-xs font-black text-[var(--text-primary)] ml-auto md:ml-2">{employeeData?.department || 'Operations'}</strong>
                </div>
              </div>
              <div className="space-y-2.5 md:border-l md:border-[var(--primary)]/10 md:pl-6">
                <div className="flex items-center gap-2">
                  <ShieldCheck className="w-4 h-4 text-[var(--primary)] shrink-0" />
                  <span className="text-xs text-[var(--text-secondary)]/80 font-bold">Designation:</span>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-[var(--text-secondary)]/80 font-bold">Days in Month:</span>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-[var(--text-secondary)]/80 font-bold">Calculation Cut-off:</span>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                <div className="bg-[var(--app-bg-primary)]/40 border border-[var(--primary)]/10 p-2.5 rounded-xl text-center">
                  <span className="text-[9px] text-[var(--text-secondary)]/60 block font-black uppercase">Office Present</span>
                  <strong className="text-sm font-black text-[var(--text-primary)]">{selectedPayslip.officePresentDays}</strong>
                </div>
                <div className="bg-[var(--app-bg-primary)]/40 border border-[var(--primary)]/10 p-2.5 rounded-xl text-center">
                  <span className="text-[9px] text-[var(--text-secondary)]/60 block font-black uppercase">WFH Days</span>
                  <strong className="text-sm font-black text-[var(--text-primary)]">{selectedPayslip.wfhDays}</strong>
                </div>
                <div className="bg-[var(--app-bg-primary)]/40 border border-[var(--primary)]/10 p-2.5 rounded-xl text-center">
                  <span className="text-[9px] text-[var(--text-secondary)]/60 block font-black uppercase">Client Visit</span>
                  <strong className="text-sm font-black text-[var(--text-primary)]">{selectedPayslip.clientVisitDays}</strong>
                </div>
                <div className="bg-[var(--app-bg-primary)]/40 border border-[var(--primary)]/10 p-2.5 rounded-xl text-center">
                  <span className="text-[9px] text-[var(--text-secondary)]/60 block font-black uppercase">Outdoor Work</span>
                  <strong className="text-sm font-black text-[var(--text-primary)]">{selectedPayslip.outdoorDays}</strong>
                </div>
                <div className="bg-[var(--app-bg-primary)]/40 border border-[var(--primary)]/10 p-2.5 rounded-xl text-center">
                  <span className="text-[9px] text-[var(--text-secondary)]/60 block font-black uppercase">Paid Leaves</span>
                  <strong className="text-sm font-black text-amber-400">{selectedPayslip.paidLeaveDays}</strong>
                </div>
                <div className="bg-[var(--app-bg-primary)]/40 border border-[var(--primary)]/10 p-2.5 rounded-xl text-center">
                  <span className="text-[9px] text-[var(--text-secondary)]/60 block font-black uppercase">Sun / Holidays</span>
                ...
                <div className="bg-[var(--primary)]/15 border border-[var(--primary)]/30 p-2.5 rounded-xl text-center col-span-2 sm:col-span-1">
                  <span className="text-[9px] text-[var(--text-secondary)]/80 block font-black uppercase">PRESENT</span>
                ...
                <div className="bg-red-500/5 border border-red-500/20 p-2.5 rounded-xl text-center col-span-2 sm:col-span-1">
                  <span className="text-[9px] text-red-300/80 block font-black uppercase">LATE DAYS</span>
                  <strong className={`text-sm font-black ${selectedPayslip.lateDays > 0 ? 'text-red-300' : 'text-[var(--text-secondary)]/60'}`}>
            ...
            <div className="space-y-2">
              ...
              <div className="p-4 bg-[var(--app-bg-primary)] rounded-2xl border border-[var(--primary)]/15 text-xs divide-y divide-[var(--primary)]/10">
                
                {/* Gross / Base */}
                <div className="flex justify-between py-2 items-center">
                  <span className="text-[var(--text-secondary)]/70 font-bold">Gross/Base Salary</span>
                ...
                <div className="flex justify-between py-2 items-center">
                  <span className="text-[var(--text-secondary)]/70 font-bold">Days in Month / PRESENT Days</span>
                ...
                {/* Subtotal */}
                <div className="flex justify-between py-2 items-center">
                  <span className="text-[var(--text-secondary)]/70 font-bold">Salary Before Deductions</span>
                  <span className="font-black text-[var(--text-primary)] font-mono">
                ...
                {/* Deductions header */}
                <div className="pt-2">
                  <span className="text-[9px] font-black text-[var(--primary)] uppercase tracking-wider block mb-1">Deductions</span>
                  <div className="space-y-1.5 pb-2">
                    <div className="flex justify-between text-[var(--text-secondary)]/70">
                ...
                {/* Net Final Out */}
                <div className="flex justify-between items-center pt-3 mt-1 border-t border-[var(--primary)]/20">
                  ...
                  <div className="text-right">
                    ...
                    <span className="text-[8px] text-[var(--text-secondary)]/40 font-black uppercase tracking-wide block mt-0.5">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-3 gap-3 text-center bg-[var(--app-bg-primary)]/40 border border-[var(--primary)]/10 p-3.5 rounded-2xl">
                <div>
                  <span className="text-[8px] text-[var(--text-secondary)]/60 block font-black uppercase leading-tight">Paid Leave Allocation</span>
                  <strong className="text-xs font-mono font-black text-[var(--text-primary)] block mt-1">
                    {selectedPayslip.allocatedPaidLeaves ?? 22}
                  </strong>
                </div>
                <div className="border-x border-[var(--primary)]/10">
                  <span className="text-[8px] text-[var(--text-secondary)]/60 block font-black uppercase leading-tight">Paid Leave Used</span>
            ...
            <div className="text-center pt-2 border-t border-[var(--primary)]/10">
              <p className="text-[9px] text-[var(--text-secondary)]/45 font-bold leading-relaxed">
