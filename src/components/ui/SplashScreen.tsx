...
export const SplashScreen: React.FC<{ onFinish: () => void }> = ({ onFinish }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-20 h-20 mx-auto bg-[var(--surface-card)] backdrop-blur-[14px] rounded-3xl flex items-center justify-center shadow-2xl border border-[#6366F1]/40 mb-4 relative">
